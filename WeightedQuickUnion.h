/* 
 * File:   UnionFindWeightedQuickUnion.h
 * Author: kurt
 *
...
*/
class WeightedQuickUnion : public UnionFindADT { 
...
public:
     ...
     */
    int  get_count() const;
    friend std::ostream& operator<<(std::ostream& ostr, const WeightedQuickUnion& qf);
...
inline int WeightedQuickUnion::get_count() const
{
    return count;
}
#endif
